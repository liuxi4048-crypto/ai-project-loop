...
Obsidian vault の `10_情報/AI Archive/`(AIニュースアーカイブ)を情報源に、
...
| 48 | 2026-07-23 | [merkle](projects/2026-07-23_merkle/) | Merkleツリーによる完全性検証・改竄検出(包含証明はO(log n))。完全性/来歴 |
| 49 | 2026-07-25 | [agent-audit](projects/2026-07-25_agent-audit/) | エージェント行動ログの事後監査+HTMLビューア。秘密読み取り→加工→送信の多段連鎖を汚染追跡。週次トレンド2026-W30(AI Agents) |
